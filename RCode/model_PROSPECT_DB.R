...
#' PROSPECT-DB model
#' Provide wavelength, leaf reflectance and leaf transmittance for SAIL model as input
...
#' @param Cbrown brown pigments content/fraction of brown leaves
#' @param Cw equivalent water thickness in g/cm² or cm
#' @param Cm dry matter content in g/cm²
#' @return LRT a data frame with three columns: lamda, refl, tran
#' @return lamda wavelength
#' @return refl leaf reflectance
#' @return tran leaf transmittance
#' @description 
# ***********************************************************************
...
# ***********************************************************************
prospect_DB <- function(N,Cab,Car,Ant,Cbrown,Cw,Cm){
  ...
  #***************************************************************************
  # refelctance and transmittance of one layer
  #***************************************************************************
  # Allen W.A., Gausman H.W., Richardson A.J., Thomas J.R. (1969)
  # Interaction of isotroic ligth with a compact plant leaf, J. Opt. Soc. Am., 
  # 59(10):1376-1379
  #****************************************************************************
  ...
  # Normal case
  #******************************************************************************
  # Stokes G.G. (1862), on the light reflected from or transmitted through
  # a pile of plates, Proc. Roy. Soc. Lond., 11:545-556.
  #******************************************************************************
  ...
  LRT <- data.frame(lambda=lambda, refl=refl, tran=tran)
  return(LRT)
}